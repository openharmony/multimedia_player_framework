...
/**
 * @brief Set the Privacy Protect callback function so that your application can

 * respond to the privacy protect events generated by the av screen capture. This interface must be called before Start is called.
 * @syscap SystemCapability.Multimedia.Media.AVScreenCapture
 * @param capture Pointer to an OH_AVScreenCapture instance
