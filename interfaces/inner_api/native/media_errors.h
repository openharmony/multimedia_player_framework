...
__attribute__((visibility("default"))) bool IsAPI14IOError(MediaServiceErrCode code);
__attribute__((visibility("default"))) MediaServiceErrCode API14IOErrorToMSError(MediaServiceErrCode code);
} // namespace Media
} // namespace OHOS
