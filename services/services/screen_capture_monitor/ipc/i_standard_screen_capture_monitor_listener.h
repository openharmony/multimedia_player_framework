...
#ifndef I_STANDARD_SCREEN_CAPTURE_MONITOR_LISTENER_H
#define I_STANDARD_SCREEN_CAPTURE_MONITOR_LISTENER_H
...
namespace OHOS {
namespace Media {
class IStandardScreenCaptureMonitorListener : public IRemoteBroker {
public:
...
#endif // I_STANDARD_SCREEN_CAPTURE_MONITOR_LISTENER_H