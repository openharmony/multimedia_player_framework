...
struct VidHierarchicalPEnable : public RecorderParam {
    explicit VidHierarchicalPEnable(bool r)
        : RecorderParam(RecorderPublicParamType::VID_HIERARCHICAL_P_ENABLE), hierarchicalPEnable(r) {}
