...
public:
    ...
    int32_t SetUserCustomInfo(int32_t sourceId, Meta &userCustomInfo) override; //TODO::SetUserCustomInfo
    int32_t SetGenre(int32_t sourceId, std::string &genre) override; //TODO::SetGenre
