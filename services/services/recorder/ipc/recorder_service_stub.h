...
private:
    ...
    int32_t SetVideoEnableStableQualityMode(MessageParcel &data, MessageParcel &reply);
    int32_t SetVideoEnableBFrame(MessageParcel &data, MessageParcel &reply);
