...
public:
    ...
    enum RecorderServiceMsg {
        ...
        SET_AUDIO_SOURCE = 8,
        SET_AUDIO_ENCODER = 9,
        SET_AUDIO_SAMPLE_RATE = 10,
        SET_AUDIO_CHANNELS = 11,
        SET_AUDIO_ENCODING_BIT_RATE = 12,
        SET_DATA_SOURCE = 13,
        SET_MAX_DURATION = 14,
        SET_OUTPUT_FORMAT = 15,
        SET_OUTPUT_FILE = 16,
        SET_FILE_GENERATION_MODE = 17,
        SET_NEXT_OUTPUT_FILE = 18,
        SET_FILE_GENERATION_MODE = 19,
        SET_MAX_FILE_SIZE = 20,
        SET_LOCATION = 21,
        SET_ORIENTATION_HINT = 22,
        SET_USER_CUSTOM_INFO = 23,
        SET_GENRE = 24,
        PREPARE = 25,
        START = 26,
        PAUSE = 27,
        ...
        RESET = 30,
        RELEASE = 31,
        SET_FILE_SPLIT_DURATION = 32,
        DESTROY = 33,
        GET_AV_RECORDER_CONFIG = 34,
        GET_LOCATION = 35,
        SET_VIDEO_IS_HDR = 36,
        SET_VIDEO_ENABLE_TEMPORAL_SCALE = 37,
		GET_AUDIO_CAPTURER_CHANGE_INFO = 38,
        GET_AVAILABLE_ENCODER = 39,
        GET_MAX_AMPLITUDE = 40,
        IS_WATERMARK_SUPPORTED = 41,
        SET_WATERMARK = 42,
        SET_META_CONFIGS = 43,
        SET_META_SOURCE = 44,
        SET_META_MIME_TYPE = 45,
        SET_META_TIMED_KEY = 46,
        SET_META_TRACK_SRC_MIME_TYPE = 47,
        GET_META_SURFACE = 48,
    };
