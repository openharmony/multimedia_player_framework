...
int32_t RecorderServer::SetAudioEncodingBitRate(int32_t sourceId, int32_t bitRate)
{
    ...
    CHECK_AND_RETURN_RET_LOG(!(encoder == AUDIO_G711MU && config_.audioBitRate != 64000), MSERR_INVALID_VAL,
        "G711-mulaw only support samplerate 8000 and audiobitrate 64000");
    auto task = std::make_shared<TaskHandler<int32_t>>([&, this] {
