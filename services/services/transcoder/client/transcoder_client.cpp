...
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {LOG_CORE, LOG_DOMAIN, "TransCoderClient"};
}
...
{
    {
        ...
        if (callback_ != nullptr) {
            callback_->OnError(MSERR_SERVICE_DIED, "mediaserver is died, please create a new transcodercallback instance again");
        }
    }
}
