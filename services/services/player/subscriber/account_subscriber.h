...
public:
    ...
    void RegisterCommonEventReceiver(CommonEventReceiver *receiver);
    void UnregisterCommonEventReceiver(CommonEventReceiver *receiver);
...
private:
    ...
    std::mutex vctMutex_;
    std::vector<CommonEventReceiver*> eventReceivers_;
