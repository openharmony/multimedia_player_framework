    ...
    int32_t &watermarkCount)
{
    ...
    CHECK_AND_RETURN_RET_LOG(ret == MSERR_OK, MSERR_UNKNOWN_RECORDER_WATERMASK,
        "ScreenCaptureServer: 0x%{public}06" PRIXPTR "AddWatermark failed %{public}d", FAKE_POINTER(this), ret);
