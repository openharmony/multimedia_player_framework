...
namespace OHOS {
namespace Media {
class ScreenCaptureControllerProxy : public IRemoteProxy<IStandardScreenCaptureController>, public NoCopyable {
public:
    explicit ScreenCaptureControllerProxy(const sptr<IRemoteObject> &impl);
...
private:
    static inline BrokerDelegator<ScreenCaptureControllerProxy> delegator_;
};
} // namespace Media
} // namespace OHOS
