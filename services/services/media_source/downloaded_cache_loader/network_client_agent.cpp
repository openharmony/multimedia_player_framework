...
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = { LOG_CORE, LOG_DOMAIN_SYSTEM_PLAYER, "DownloadedNetworkClientAgent" };
...
namespace OHOS {
namespace Media {
void *DownloadedNetworkClientAgent::handler_ = nullptr;
DownloadedNetworkClientAgent::CreateFunc DownloadedNetworkClientAgent::createFunc_ = nullptr;
std::mutex DownloadedNetworkClientAgent::loadMutex_;

bool DownloadedNetworkClientAgent::Create()
{
...
void DownloadedNetworkClientAgent::Destroy()
{
    MEDIA_LOG_I("Destroy");
    std::lock_guard<std::mutex> lock(loadMutex_);
    createFunc_ = nullptr;
...
void DownloadedNetworkClientAgent::Unload()
{
...
std::shared_ptr<NetworkClient> DownloadedNetworkClientAgent::NewInstance(RxHeader headCallback,
