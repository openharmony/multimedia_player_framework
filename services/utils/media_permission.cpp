...
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {LOG_CORE, LOG_DOMAIN_PLAYER, "MediaPermission"};
};
...
{
    MEDIA_LOGD("enter and check appUid: %{public}d appPid: %{public}d", appUid, appPid);
