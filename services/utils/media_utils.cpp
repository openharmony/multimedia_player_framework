...
const std::unordered_map<Status, int32_t> transcoder_statusPair = {
    ...
    {Status::ERROR_VID_DEC_INIT_FAILED, MSERR_VID_DEC_INIT_FAILED},
    {Status::ERROR_AUD_DEC_INIT_FAILED, MSERR_AUD_DEC_INIT_FAILED},
    {Status::ERROR_VID_DEC_CONFIGURE_FAILED, MSERR_VID_DEC_CONFIGURE_FAILED},
    {Status::ERROR_AUD_DEC_CONFIGURE_FAILED, MSERR_AUD_DEC_CONFIGURE_FAILED},
    {Status::ERROR_VID_ENHANCER_CONFIGURE_FAILED, MSERR_VID_ENHANCER_CONFIGURE_FAILED},
    {Status::ERROR_NO_VALID_TRACK_FOUND, MSERR_NO_VALID_TRACK_FOUND},
    {Status::ERROR_INVALID_AUDIO_BITRATE, MSERR_INVALID_AUDIO_BITRATE},
...
const std::array<std::pair<PlaybackRateMode, float>, 12> PLAY_RATE_REFS = {
    ...
    std::make_pair(PlaybackRateMode::SPEED_FORWARD_4_00_X, 4.00),
    std::make_pair(PlaybackRateMode::SPEED_FORWARD_1_20_X, 1.20),
};
