...
static const std::unordered_map<int32_t, std::string> AVMETA_KEY_TO_X_MAP = {
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_ALBUM, Tag::MEDIA_ALBUM),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_ALBUM_ARTIST, Tag::MEDIA_ALBUM_ARTIST),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_ARTIST, Tag::MEDIA_ARTIST),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_AUTHOR, Tag::MEDIA_AUTHOR),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_COMPOSER, Tag::MEDIA_COMPOSER),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_DATE_TIME, Tag::MEDIA_DATE),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_DATE_TIME_FORMAT, ""),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_DURATION, Tag::MEDIA_DURATION),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_GENRE, Tag::MEDIA_GENRE),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_HAS_AUDIO, Tag::MEDIA_HAS_AUDIO),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_HAS_VIDEO, Tag::MEDIA_HAS_VIDEO),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_MIME_TYPE, Tag::MIME_TYPE),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_NUM_TRACKS, Tag::MEDIA_TRACK_COUNT),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_SAMPLE_RATE, Tag::AUDIO_SAMPLE_RATE),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_TITLE, Tag::MEDIA_TITLE),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_VIDEO_HEIGHT, Tag::VIDEO_HEIGHT),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_VIDEO_WIDTH, Tag::VIDEO_WIDTH),
    AVMETA_KEY_TO_X_MAP_ITEM(AV_KEY_VIDEO_ORIENTATION, Tag::VIDEO_ROTATION),
};
