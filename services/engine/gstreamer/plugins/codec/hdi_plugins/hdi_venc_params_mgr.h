...
#ifndef HDI_VENC_PARAMS_MGR_H
#define HDI_VENC_PARAMS_MGR_H
...
namespace OHOS {
namespace Media {
class HdiVencParamsMgr : public HdiParamsMgr {
public:
    HdiVencParamsMgr();
    ~HdiVencParamsMgr() override;
