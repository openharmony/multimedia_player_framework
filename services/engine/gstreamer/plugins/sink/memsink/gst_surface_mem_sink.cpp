...
static void gst_surface_mem_sink_dump_buffer(GstSurfaceMemSink *self, GstBuffer *buffer)
{
    ...
    GST_DEBUG_OBJECT(self, "format %s, stride width %u, stride height %u, stride_size %u,
        info.size %" G_GSIZE_FORMAT "", format, stride_width, stride_height, stride_size, info.size);
