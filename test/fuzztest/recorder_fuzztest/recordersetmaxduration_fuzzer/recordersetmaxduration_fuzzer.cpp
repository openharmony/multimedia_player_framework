...
#include "recordersetmaxduration_fuzzer.h"
#include <iostream>
#include "aw_common.h"
#include "string_ex.h"
...
namespace OHOS {
namespace Media {
RecorderSetMaxDurationFuzzer::RecorderSetMaxDurationFuzzer()
{
}
...
bool RecorderSetMaxDurationFuzzer::FuzzRecorderSetMaxDuration(uint8_t *data, size_t size)
{
    ...
    g_videoRecorderConfig.outputFd = open("/data/test/media/recorder_SetMaxDuration.mp4", O_RDWR);
    ...
    if (g_videoRecorderConfig.outputFd >= 0) {
        ...
        g_videoRecorderConfig.duration = *reinterpret_cast<int32_t *>(data);
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestRecorderSetMaxDuration(data, size);
    return 0;
}