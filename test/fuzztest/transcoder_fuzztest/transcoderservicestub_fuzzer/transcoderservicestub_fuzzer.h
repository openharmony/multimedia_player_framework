...
#ifndef TRANSCODERSERVICESTUB_FUZZER
#define TRANSCODERSERVICESTUB_FUZZER
...
#define FUZZ_PROJECT_NAME "transcoderservicestub_fuzzer"

namespace OHOS {
namespace Media {
class TranscoderServiceStubFuzzer {
public:
