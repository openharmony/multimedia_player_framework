...
#ifndef TRANSCODERSERVICESTUBCONCURRENT_FUZZER
#define TRANSCODERSERVICESTUBCONCURRENT_FUZZER
...
#define FUZZ_PROJECT_NAME "transcoderservicestubconcurrent_fuzzer"

namespace OHOS {
namespace Media {
class TranscoderServiceStubFuzzerConcurrent {
public:
