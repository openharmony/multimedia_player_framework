...
#include "lowpowervideosink_fuzzer.h"
#include <unistd.h>
#include <fcntl.h>
...
LowPowerVideoSinkFuzz::LowPowerVideoSinkFuzz()
{
}
...
sptr<IRemoteStub<IStandardLppVideoStreamerService>> LowPowerVideoSinkFuzz::GetVideoSinkStub()
{
...
bool LowPowerVideoSinkFuzz::RunFuzz(uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size)
{
    ...
    close(fd);
    LowPowerVideoSinkFuzz videoSink;
