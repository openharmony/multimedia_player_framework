...
#include "lowpoweraudiosinkconcurrent_fuzzer.h"
#include <unistd.h>
#include <fcntl.h>
...
LowPowerAudioSinkconcurrentFuzz::LowPowerAudioSinkconcurrentFuzz()
{
}
...
sptr<IRemoteStub<IStandardLppAudioStreamerService>> LowPowerAudioSinkconcurrentFuzz::GetAudioSinkStub()
{
...
std::shared_ptr<AVBuffer> LowPowerAudioSinkconcurrentFuzz::ReadAVBufferFromLocalFile(int32_t start, int32_t size)
{
...
bool LowPowerAudioSinkconcurrentFuzz::RunFuzz(uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size)
{
    ...
    close(fd);
    LowPowerAudioSinkconcurrentFuzz audioSink;
