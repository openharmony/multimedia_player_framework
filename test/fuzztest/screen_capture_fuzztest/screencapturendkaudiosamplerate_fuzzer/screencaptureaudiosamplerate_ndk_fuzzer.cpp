...
#include "screencaptureaudiosamplerate_ndk_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureAudioSampleRateNdkFuzzer::ScreenCaptureAudioSampleRateNdkFuzzer()
{
}
...
bool ScreenCaptureAudioSampleRateNdkFuzzer::FuzzScreenCaptureAudioSampleRateNdk(uint8_t *data, size_t size)
{
...
bool FuzzTestScreenCaptureAudioSampleRateNdk(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureAudioSampleRateNdkFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureAudioSampleRateNdk(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureAudioSampleRateNdk(data, size);
    return 0;
}