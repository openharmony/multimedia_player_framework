...
namespace OHOS {
namespace Media {
ScreenCaptureShowCursorFuzzer::ScreenCaptureShowCursorFuzzer()
{
}
...
bool ScreenCaptureShowCursorFuzzer::FuzzScreenCaptureShowCursor(uint8_t *data, size_t size)
{
...
bool FuzzTestScreenCaptureShowCursor(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureShowCursorFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureShowCursor(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureShowCursor(data, size);
    return 0;
}