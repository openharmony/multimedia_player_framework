...
#define FUZZ_PROJECT_NAME "screencaptureskipprivacymode_ndk_fuzzer"

namespace OHOS {
namespace Media {
class ScreenCaptureSkipPrivacyModeNdkFuzzer : public TestNdkScreenCapture {
public:
    ScreenCaptureSkipPrivacyModeNdkFuzzer();
    ~ScreenCaptureSkipPrivacyModeNdkFuzzer();
    bool FuzzScreenCaptureSkipPrivacyModeNdk(uint8_t *data, size_t size);
