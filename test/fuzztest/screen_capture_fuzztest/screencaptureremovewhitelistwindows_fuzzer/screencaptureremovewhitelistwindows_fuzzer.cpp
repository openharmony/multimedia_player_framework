...
#include "screencaptureremovewhitelistwindows_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureRemoveWhiteListWindowsFuzzer::ScreenCaptureRemoveWhiteListWindowsFuzzer()
{
}
...
bool ScreenCaptureRemoveWhiteListWindowsFuzzer::FuzzScreenCaptureRemoveWhiteListWindows(uint8_t *data, size_t size)
{
    ...
    TestScreenCapture::RemoveWhiteListWindows(windowIDsVec);
    sleep(recorderTime);
...
bool FuzzTestScreenCaptureRemoveWhiteListWindows(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureRemoveWhiteListWindowsFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureRemoveWhiteListWindows(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureRemoveWhiteListWindows(data, size);
    return 0;
}