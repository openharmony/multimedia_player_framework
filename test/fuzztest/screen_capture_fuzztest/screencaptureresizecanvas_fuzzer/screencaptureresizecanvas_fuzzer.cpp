...
#include "screencaptureresizecanvas_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureResizeCanvasFuzzer::ScreenCaptureResizeCanvasFuzzer()
{
}
...
bool ScreenCaptureResizeCanvasFuzzer::FuzzScreenCaptureResizeCanvas(uint8_t *data, size_t size)
{
    ...
    TestScreenCapture::ResizeCanvas(fdp.ConsumeIntegral<int32_t>(),
...
bool FuzzTestScreenCaptureResizeCanvas(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    return testScreenCapture.FuzzScreenCaptureResizeCanvas(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureResizeCanvas(data, size);
    return 0;
}