...
#include "screencapturesetmaxframerate_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureSetMaxFrameRateFuzzer::ScreenCaptureSetMaxFrameRateFuzzer()
{
}
...
bool ScreenCaptureSetMaxFrameRateFuzzer::FuzzScreenCaptureSetMaxFrameRate(uint8_t *data, size_t size)
{
...
bool FuzzTestScreenCaptureSetMaxFrameRate(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureSetMaxFrameRateFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureSetMaxFrameRate(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureSetMaxFrameRate(data, size);
    return 0;
}