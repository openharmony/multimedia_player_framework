...
#include "screencapturesetmaxframerate_ndk_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureSetMaxFrameRateNdkFuzzer::ScreenCaptureSetMaxFrameRateNdkFuzzer()
{
}
...
bool ScreenCaptureSetMaxFrameRateNdkFuzzer::FuzzScreenCaptureSetMaxFrameRateNdk(
...
bool FuzzTestScreenCaptureSetMaxFrameRateNdk(uint8_t *data, size_t size)
{
    ...
    ScreenCaptureSetMaxFrameRateNdkFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureSetMaxFrameRateNdk(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureSetMaxFrameRateNdk(data, size);
    return 0;
}