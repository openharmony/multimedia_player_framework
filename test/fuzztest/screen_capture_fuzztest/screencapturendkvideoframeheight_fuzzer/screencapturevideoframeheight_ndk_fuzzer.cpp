...
#include "screencapturevideoframeheight_ndk_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureVideoFrameHeightNdkFuzzer::ScreenCaptureVideoFrameHeightNdkFuzzer()
{
}
...
bool ScreenCaptureVideoFrameHeightNdkFuzzer::FuzzScreenCaptureVideoFrameHeightNdk(uint8_t *data, size_t size)
{
...
bool FuzzTestScreenCaptureVideoFrameHeightNdk(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureVideoFrameHeightNdkFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureVideoFrameHeightNdk(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureVideoFrameHeightNdk(data, size);
    return 0;
}