...
namespace OHOS {
namespace Media {
ScreenCaptureShowCursorNdkFuzzer::ScreenCaptureShowCursorNdkFuzzer()
{
}
...
bool ScreenCaptureShowCursorNdkFuzzer::FuzzScreenCaptureShowCursorNdk(
...
bool FuzzTestScreenCaptureShowCursorNdk(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureShowCursorNdkFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureShowCursorNdk(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureShowCursorNdk(data, size);
    return 0;
}