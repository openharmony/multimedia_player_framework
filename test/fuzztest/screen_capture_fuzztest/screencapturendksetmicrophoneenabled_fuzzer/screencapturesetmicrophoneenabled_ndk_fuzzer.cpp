...
#include "screencapturesetmicrophoneenabled_ndk_fuzzer.h"
...
namespace OHOS {
namespace Media {
ScreenCaptureSetMicrophoneEnabledNdkFuzzer::ScreenCaptureSetMicrophoneEnabledNdkFuzzer()
{
}
...
bool ScreenCaptureSetMicrophoneEnabledNdkFuzzer::FuzzScreenCaptureSetMicrophoneEnabledNdk(uint8_t *data, size_t size)
{
...
bool FuzzTestScreenCaptureSetMicrophoneEnabledNdk(uint8_t *data, size_t size)
{
    if (data == nullptr) {
        return true;
    }
    ...
    ScreenCaptureSetMicrophoneEnabledNdkFuzzer testScreenCapture;
    return testScreenCapture.FuzzScreenCaptureSetMicrophoneEnabledNdk(data, size);
}
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzTestScreenCaptureSetMicrophoneEnabledNdk(data, size);
    return 0;
}