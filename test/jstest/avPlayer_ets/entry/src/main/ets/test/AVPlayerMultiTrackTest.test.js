...
export default function AVPlayerMultiTrackTest() {
    describe('AVPlayerMultiTrackTest', function () {
        ...
        const AUDIO_SOURCE = 'audio_mp3_aac.mkv';
        const VIDEO_NOAUDIO = 'H264_NONE.mp4';
        const UNSUPPORTED_AUDIO = 'h264_1152_648_ac3_aac.mkv';
        ...
        */
        ...
        /* *
            * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_PLAYER_MULTI_AUDIOTRACK_FUNC_0400
            * @tc.name      : 004.test only audio select and deselect audio track
            * @tc.desc      : test only audio select and deselect audio track
            * @tc.size      : MediumTest
            * @tc.type      : Function test
            * @tc.level     : Level1
        */
        it('SUB_MULTIMEDIA_MEDIA_VIDEO_PLAYER_MULTI_AUDIOTRACK_FUNC_0400', 0, async function (done) {
            async function preparedOperation() {
                await getAudioTracks();
                await getCurrentAudioTrack();
                avPlayer.selectTrack(currentTrack);
            ...
            await testChangeTrack(audioFd, preparedOperation, playedOperation, stoppedOperation, undefined);
        })
