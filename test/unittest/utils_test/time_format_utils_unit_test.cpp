...
HWTEST_F(TimeFormatUtilsUnitTest, ParseIso8601TimeZoneOffset_004, TestSize.Level0)
{
    ...
    EXPECT_EQ(TimeFormatUtils::ParseIso8601TimeZoneOffset("+0:00"), 0L);
    EXPECT_EQ(TimeFormatUtils::ParseIso8601TimeZoneOffset("+08:0"), 0L);
}
...
HWTEST_F(TimeFormatUtilsUnitTest, ParseIso8601TimeZoneOffset_006, TestSize.Level0)
{
    ...
    EXPECT_EQ(TimeFormatUtils::ParseIso8601TimeZoneOffset("+08000"), 0L);
}

HWTEST_F(TimeFormatUtilsUnitTest, ParseIso8601TimeZoneOffset_007, TestSize.Level0)
{
    // Extreme but valid values
    EXPECT_EQ(TimeFormatUtils::ParseIso8601TimeZoneOffset("+1400"), 14 * SEC_PER_HOUR);
    EXPECT_EQ(TimeFormatUtils::ParseIso8601TimeZoneOffset("-1200"), -12 * SEC_PER_HOUR);
