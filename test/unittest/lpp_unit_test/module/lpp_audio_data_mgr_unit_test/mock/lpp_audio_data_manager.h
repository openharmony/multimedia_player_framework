...
public:
    ...
    virtual int32_t ProcessNewData(sptr<LppDataPacket> framePacket);
    virtual int32_t SetDecoderInputProducer(sptr<Media::AVBufferQueueProducer> producer);
    void OnBufferAvailable();
    virtual void SetEventReceiver(std::shared_ptr<EventReceiver> eventReceiver);
