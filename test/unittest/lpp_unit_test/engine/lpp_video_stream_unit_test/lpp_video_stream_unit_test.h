 ...
 */
#ifndef LPP_VIDEO_STREAM_UNIT_TEST_H
#define LPP_VIDEO_STREAM_UNIT_TEST_H
...
namespace OHOS {
namespace Media {
class LppVideoStreamUnitTest : public testing::Test {
public:
    ...
    void TearDown(void);
protected:
    std::shared_ptr<HiLppVideoStreamerImpl> videoStreamImpl_ {nullptr};
