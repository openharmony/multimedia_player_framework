...
/**
* @tc.name    : Test Prepare API
* @tc.number  : Prepare_012
* @tc.desc    : Test Prepare with input width exceeding MAX_INPUT_VIDEO_WIDTH.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, Prepare_012, TestSize.Level0)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 8000;
    transcoder_->inputVideoHeight_ = 4320;
    std::string widthMetaKey = Tag::VIDEO_WIDTH;
    transcoder_->videoEncFormat_->SetData(widthMetaKey, 1920);
    std::string heightMetaKey = Tag::VIDEO_HEIGHT;
    transcoder_->videoEncFormat_->SetData(heightMetaKey, 1080);
    int32_t ret = transcoder_->Prepare();
...
/**
* @tc.name    : Test Prepare API
* @tc.number  : Prepare_013
* @tc.desc    : Test Prepare with input height exceeding MAX_INPUT_VIDEO_HEIGHT.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, Prepare_013, TestSize.Level0)
{
    transcoder_->isExistVideoTrack_ = true;
...
/**
* @tc.name    : Test Prepare API
* @tc.number  : Prepare_014
* @tc.desc    : Test Prepare with output width exceeding MAX_OUTPUT_VIDEO_WIDTH.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, Prepare_014, TestSize.Level0)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 4320;
    std::string widthMetaKey = Tag::VIDEO_WIDTH;
    transcoder_->videoEncFormat_->SetData(widthMetaKey, 5000);
    std::string heightMetaKey = Tag::VIDEO_HEIGHT;
    transcoder_->videoEncFormat_->SetData(heightMetaKey, 2160);
    int32_t ret = transcoder_->Prepare();
...
/**
* @tc.name    : Test Prepare API
* @tc.number  : Prepare_015
* @tc.desc    : Test Prepare with output height exceeding MAX_OUTPUT_VIDEO_HEIGHT.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, Prepare_015, TestSize.Level0)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 4320;
    std::string widthMetaKey = Tag::VIDEO_WIDTH;
    transcoder_->videoEncFormat_->SetData(widthMetaKey, 3840);
    std::string heightMetaKey = Tag::VIDEO_HEIGHT;
    transcoder_->videoEncFormat_->SetData(heightMetaKey, 5000);
    int32_t ret = transcoder_->Prepare();
    EXPECT_EQ(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
...
/**
* @tc.name    : Test Prepare API
* @tc.number  : Prepare_016
* @tc.desc    : Test Prepare with input resolution at max boundary (7680x4320).
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, Prepare_016, TestSize.Level0)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 4320;
    ...
    transcoder_->videoEncFormat_->SetData(heightMetaKey, 2160);
    int32_t ret = transcoder_->Prepare();
    EXPECT_NE(ret, MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
    EXPECT_NE(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
 
/**
* @tc.name    : Test CheckResolutionRange API
* @tc.number  : CheckResolutionRange_001
* @tc.desc    : Test CheckResolutionRange with resolution in range.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, CheckResolutionRange_001, TestSize.Level0)
{
    int32_t ret = transcoder_->CheckResolutionRange(1920, 1080, 7680, 4320,
...
* @tc.desc    : Test CheckResolutionRange with width exceeding max.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, CheckResolutionRange_002, TestSize.Level0)
{
...
* @tc.desc    : Test CheckResolutionRange with output resolution at max boundary (4096x4096).
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, CheckResolutionRange_003, TestSize.Level0)
{
...
/**
* @tc.name    : Test CheckCodecCapability API
* @tc.number  : CheckCodecCapability_001
* @tc.desc    : Test CheckCodecCapability with empty mime returns MSERR_OK.
* @tc.require :
*/
HWTEST_F(HitranscodeUnitTest, CheckCodecCapability_001, TestSize.Level0)
{
