...
#include "media_impl_unit_test.h"
...
void MediaImplUnitTest::SetUpTestCase(void)
{
}

void MediaImplUnitTest::TearDownTestCase(void)
{
}

void MediaImplUnitTest::SetUp(void)
{
    hiplayer_ = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
}

void MediaImplUnitTest::TearDown(void)
{
    hiplayer_ = nullptr;
}
...
*/
HWTEST_F(MediaImplUnitTest, GetRealPath_001, TestSize.Level0)
{
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, GetRealPath_002, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string url = "file";
    std::string realUrlPath;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, GetRealPath_003, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetSource_001, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string uri = "";
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetSource_002, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string uri = "file://";
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetSource_003, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string uri = "http://";
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetSource_004, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetSource_005, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetMediaSource_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetMediaSource_002, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetMediaSource_003, TestSize.Level0)
{
    // 1. Set up the test environment
    std::map<std::string, std::string> sourceHeader;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetMediaSource_004, TestSize.Level0)
{
    // 1. Set up the test environment
    std::map<std::string, std::string> sourceHeader;
    std::shared_ptr<AVMediaSource> mediaSource = std::make_shared<AVMediaSource>("http://test.mp3", sourceHeader);
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetMediaSource_005, TestSize.Level0)
{
    // 1. Set up the test environment
    std::map<std::string, std::string> sourceHeader;
    std::shared_ptr<AVMediaSource> mediaSource = std::make_shared<AVMediaSource>("http://test.mp3", sourceHeader);
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, ResetIfSourceExisted_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, ResetIfSourceExisted_002, TestSize.Level0)
{
    // 1. Set up the test environment
    hiplayer_->demuxer_ = FilterFactory::Instance().CreateFilter<DemuxerFilter>("builtin.player.demuxer",
        FilterType::FILTERTYPE_DEMUXER);
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, BreakIfInterruptted_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetInterruptState_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetInterruptState_002, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetInterruptState_003, TestSize.Level0)
{
    bool isInterruptNeeded = false;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, DoInitializeForHttp_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, DoInitializeForHttp_002, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, DoInitializeForHttp_003, TestSize.Level0)
{
    // 1. Set up the test environment
    hiplayer_->isNetWorkPlay_ = true;
    std::string name = "builtin.player.demuxer";
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, DoInitializeForHttp_004, TestSize.Level0)
{
    // 1. Set up the test environment
    hiplayer_->isNetWorkPlay_ = true;
    std::string name = "builtin.player.demuxer";
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, Play_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, Play_002, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, Play_003, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, Play_004, TestSize.Level0)
{
    // 1. Set up the test environment
    hiplayer_->pipelineStates_ = PlayerStates::PLAYER_PLAYBACK_COMPLETE;
    hiplayer_->isStreaming_ = false;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, PauseDemuxer_001, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SeekToCurrentTime_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, HandleSeek_001, TestSize.Level0)
{
    // 1. Set up the test environment
    int64_t seekPos = 100;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, NotifySeek_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, Seek_001, TestSize.Level0)
{
    // 1. Set up the test environment
...
HWTEST_F(MediaImplUnitTest, GetCurrentTrack_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, SelectTrack_001, TestSize.Level0)
{
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
        std::make_shared<DemuxerFilterMock>(name, FilterType::FILTERTYPE_DEMUXER);
...
HWTEST_F(MediaImplUnitTest, DeselectTrack_001, TestSize.Level0)
{
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
        std::make_shared<DemuxerFilterMock>(name, FilterType::FILTERTYPE_DEMUXER);
...
HWTEST_F(MediaImplUnitTest, GetPlaybackInfo_001, TestSize.Level0)
{
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
        std::make_shared<DemuxerFilterMock>(name, FilterType::FILTERTYPE_DEMUXER);
...
HWTEST_F(MediaImplUnitTest, GetPlaybackStatisticMetrics_001, TestSize.Level0)
{
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
        std::make_shared<DemuxerFilterMock>(name, FilterType::FILTERTYPE_DEMUXER);
...
HWTEST_F(MediaImplUnitTest, InitAudioDefaultTrackIndex_001, TestSize.Level0)
{
    hiplayer_->demuxer_ = nullptr;
...
HWTEST_F(MediaImplUnitTest, ReleaseHiPlayerImplHasSubtitleSink_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, ReleaseHiPlayerImplHasNoDemuxer_001, TestSize.Level0)
{
    hiplayer_->demuxer_ = nullptr;
    hiplayer_->ReleaseInner();
...
HWTEST_F(MediaImplUnitTest, InitWithNoSyncManager_001, TestSize.Level0)
{
    hiplayer_->syncManager_ = nullptr;
    EXPECT_EQ(hiplayer_->Init(), Status::OK);
}

HWTEST_F(MediaImplUnitTest, SetDefaultAudioRenderInfoWithNullptrMeta_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, ValidSeekTime_001, TestSize.Level0)
{
    hiplayer_->endTimeWithMode_ = 100;
...
HWTEST_F(MediaImplUnitTest, InValidSeekTime_001, TestSize.Level0)
{
    hiplayer_->endTimeWithMode_ = 100;
    hiplayer_->startTimeWithMode_  = 0;
...
HWTEST_F(MediaImplUnitTest, InValidSeekTime_002, TestSize.Level0)
{
    hiplayer_->endTimeWithMode_ = 100;
...
HWTEST_F(MediaImplUnitTest, GetPlayStartTime_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, GetPlayStartTimeWithValidTime_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, GetPlayStartTimeWithInValidTime_001, TestSize.Level0)
{
    hiplayer_->startTimeWithMode_ = 0;
    hiplayer_->endTimeWithMode_  = 100;
    hiplayer_->playRangeStartTime_ = PLAY_RANGE_DEFAULT_VALUE;
...
HWTEST_F(MediaImplUnitTest, GetPlayStartTimeWithInValidTime_002, TestSize.Level0)
{
    int32_t defaultStartTime = 0;
    hiplayer_->startTimeWithMode_ = PLAY_RANGE_DEFAULT_VALUE;
    hiplayer_->endTimeWithMode_  = 100;
...
HWTEST_F(MediaImplUnitTest, GetPlayStartTimeWithInValidTime_003, TestSize.Level0)
{
    int32_t defaultStartTime = 0;
...
HWTEST_F(MediaImplUnitTest, SetPlayRangeWithMode_001, TestSize.Level0)
{
    int64_t start = -1;
    int64_t end = -1;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
HWTEST_F(MediaImplUnitTest, SetPlayRangeWithMode_002, TestSize.Level0)
{
    int64_t start = 0;
    int64_t end = 100;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
HWTEST_F(MediaImplUnitTest, SetPlayRangeWithMode_003, TestSize.Level0)
{
    int64_t start = 0;
    int64_t end = 100;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
HWTEST_F(MediaImplUnitTest, SetPlayRangeWithMode_004, TestSize.Level0)
{
    int64_t start = 0;
    int64_t end = 100;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
HWTEST_F(MediaImplUnitTest, SetPlayRangeWithMode_005, TestSize.Level0)
{
    int64_t start = 0;
    int64_t end = 100;
    PlayerSeekMode mode = PlayerSeekMode::SEEK_NEXT_SYNC;
...
HWTEST_F(MediaImplUnitTest, SetRenderFirstFrame_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, SetRenderFirstFrame_002, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, PrepareAsync_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, PrepareAsync_002, TestSize.Level0)
{
    int32_t ret = hiplayer_->SetSource(VIDEO_FILE1);
    EXPECT_EQ(MSERR_OK, ret);
    hiplayer_->pipelineStates_ = PlayerStates::PLAYER_STOPPED;
...
HWTEST_F(MediaImplUnitTest, SetAudioEffectMode_001, TestSize.Level0)
{
    EXPECT_EQ(MSERR_OK, hiplayer_->SetAudioEffectMode(0));
}

HWTEST_F(MediaImplUnitTest, SetAudioEffectMode_002, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, GetAudioEffectMode_001, TestSize.Level0)
{
    hiplayer_->audioSink_ = FilterFactory::Instance().CreateFilter<AudioSinkFilter>("player.audiosink",
        FilterType::FILTERTYPE_ASINK);
    int32_t effect = 1;
...
HWTEST_F(MediaImplUnitTest, SetPlaybackSpeed_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, SetPlaybackRate_001, TestSize.Level0)
{
    float rate = 2.0f;
    hiplayer_->subtitleSink_ = FilterFactory::Instance().CreateFilter<SubtitleSinkFilter>("player.subtitlesink",
        FilterType::FILTERTYPE_SSINK);
...
HWTEST_F(MediaImplUnitTest, SetPlaybackSpeed_002, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, SetPlaybackRate_002, TestSize.Level0)
{
    float rate = 2.0f;
    hiplayer_->audioSink_  = FilterFactory::Instance().CreateFilter<AudioSinkFilter>("player.audiosink",
        FilterType::FILTERTYPE_ASINK);
...
HWTEST_F(MediaImplUnitTest, IsNeedAudioSinkChangeTrack_001, TestSize.Level0)
{
    std::shared_ptr<Meta> meta = std::make_shared<Meta>();
    std::vector<std::shared_ptr<Meta>> trackInfos{meta};
    int32_t trackId = 0;
...
HWTEST_F(MediaImplUnitTest, InnerSelectTrack_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, GetSarVideoWidth_001, TestSize.Level0)
{
    double videoSar = 0;
    double width = 1;
...
HWTEST_F(MediaImplUnitTest, GetSarVideoHeight_001, TestSize.Level0)
{
    std::shared_ptr<Meta> trackInfo = std::make_shared<Meta>();
    double videoSar = 2;
    int32_t height = 2;
...
HWTEST_F(MediaImplUnitTest, SetMaxAmplitudeCbStatus_001, TestSize.Level0)
{
    bool status = true;
    hiplayer_->audioSink_ = FilterFactory::Instance().CreateFilter<AudioSinkFilter>("player.audiosink",
        FilterType::FILTERTYPE_ASINK);
...
HWTEST_F(MediaImplUnitTest, TestHiplayerImplDestructor, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, TestHiplayerImplLag_001, TestSize.Level0)
{
    std::unique_ptr<HiPlayerImpl> player = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
    ...
    player->playerEventReceiver_->OnDfxEvent(
        {"MediaImplUnitTest", DfxEventType::DFX_INFO_PLAYER_AUDIO_LAG, 1000});
    usleep(100000); // sleep 100 ms to wait for hasReported_ change
    EXPECT_EQ(player->dfxAgent_->hasReported_, true);
}
 
HWTEST_F(MediaImplUnitTest, TestHiplayerImplLag_002, TestSize.Level0)
{
    std::unique_ptr<HiPlayerImpl> player = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
    ASSERT_NE(player, nullptr);
    ASSERT_NE(player->dfxAgent_, nullptr);
    ...
    ASSERT_NE(player->playerEventReceiver_, nullptr);
    player->playerEventReceiver_->OnDfxEvent(
        {"MediaImplUnitTest", DfxEventType::DFX_INFO_PLAYER_VIDEO_LAG, 1000});
    usleep(100000); // sleep 100 ms to wait for hasReported_ change
    EXPECT_EQ(player->dfxAgent_->hasReported_, true);
}
 
HWTEST_F(MediaImplUnitTest, TestHiplayerImplLag_003, TestSize.Level0)
{
    std::unique_ptr<HiPlayerImpl> player = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
    ASSERT_NE(player, nullptr);
    ASSERT_NE(player->dfxAgent_, nullptr);
    ...
    ASSERT_NE(player->playerEventReceiver_, nullptr);
    player->playerEventReceiver_->OnDfxEvent(
        {"MediaImplUnitTest", DfxEventType::DFX_INFO_PLAYER_STREAM_LAG, 1000});
    usleep(100000); // sleep 100 ms to wait for hasReported_ change
    EXPECT_EQ(player->dfxAgent_->hasReported_, true);
}
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, TestIsSeekContinuousSupported_001, TestSize.Level0)
{
    std::unique_ptr<HiPlayerImpl> player = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
    ASSERT_NE(player, nullptr);
...
HWTEST_F(MediaImplUnitTest, TestSetSuperResolution_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, TestSetSuperResolution_002, TestSize.Level0)
{
    std::unique_ptr<HiPlayerImpl> player = std::make_unique<HiPlayerImpl>(0, 0, 0, 0);
    ASSERT_NE(player, nullptr);
    player->videoDecoder_ = FilterFactory::Instance().CreateFilter<DecoderSurfaceFilter>("player.videodecoder",
...
HWTEST_F(MediaImplUnitTest, SetCameraPostprocessing_001, TestSize.Level0)
{
...
HWTEST_F(MediaImplUnitTest, TestSetVideoWindowSize_001, TestSize.Level0)
{
    int32_t width = 0;
    int32_t height = 0;
...
HWTEST_F(MediaImplUnitTest, TestSetPlaybackStrategy_001, TestSize.Level0)
{
    AVPlayStrategy strategy;
...
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_001, TestSize.Level0)
{
    DfxEvent event;
...
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_002, TestSize.Level0)
{
    DfxEvent event;
    event.callerName = "TEST";
    event.param = static_cast<uint32_t>(1024);
...
* @tc.desc  : Test the scenario where the caller is not DEMUXER_PLUGIN, report coverage
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_003, TestSize.Level0)
{
    DfxEvent event;
    event.callerName = "TEST";
    event.param = static_cast<uint32_t>(2048);
...
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_004, TestSize.Level0)
{
    DfxEvent event;
...
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_005, TestSize.Level0)
{
...
* @tc.desc  : Test the scenario where the caller is DEMUXER_PLUGIN, Exceeding the limit
*/
HWTEST_F(MediaImplUnitTest, TestHandleMemoryUsageEvent_006, TestSize.Level0)
{
    uint32_t reportMemory = 50 * 1024 * 1024;
    DfxEvent event;
    event.callerName = "DEMUXER_PLUGIN";
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, IsLivingMaxDelayTimeValid_001, TestSize.Level0)
{
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, IsNeedChangePlaySpeed_001, TestSize.Level0)
{
    hiplayer_->demuxer_ = FilterFactory::Instance().CreateFilter<DemuxerFilter>("builtin.player.demuxer",
        FilterType::FILTERTYPE_DEMUXER);
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, IsNeedChangePlaySpeed_002, TestSize.Level0)
{
    hiplayer_->demuxer_ = FilterFactory::Instance().CreateFilter<DemuxerFilter>("builtin.player.demuxer",
        FilterType::FILTERTYPE_DEMUXER);
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, IsPauseForTooLong_001, TestSize.Level0)
{
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, SetFlvLiveParams_001, TestSize.Level0)
{
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, UpdateFlvLiveParams_001, TestSize.Level0)
{
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, SetAudioHapticsSyncId_001, TestSize.Level0)
{
...
* @tc.require :
*/
HWTEST_F(MediaImplUnitTest, CleanUnusedListener_001, TestSize.Level0)
{
    int32_t ret = hiplayer_->SetSource(VIDEO_FILE1);
    EXPECT_EQ(MSERR_OK, ret);
    hiplayer_->pipelineStates_ = PlayerStates::PLAYER_STOPPED;
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetBuffering_001, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetBuffering_002, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetBuffering_003, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
...
* @tc.require : issueI5NZAQ
*/
HWTEST_F(MediaImplUnitTest, SetBuffering_004, TestSize.Level0)
{
    // 1. Set up the test environment
    std::string name = "builtin.player.demuxer";
    std::shared_ptr<DemuxerFilterMock> demuxerMock =
