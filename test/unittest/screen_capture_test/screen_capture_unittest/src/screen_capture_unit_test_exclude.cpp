...
HWTEST_F(ScreenCaptureUnitTest, screen_capture_exclude_content_02, TestSize.Level2)
{
    ...
    EXPECT_EQ(MSERR_OK, screenCapture_->ExcludeAudioContent(SCREEN_CAPTURE_NOTIFICATION_AUDIO,
        static_cast<int32_t>(audioIds.size())));
    sleep(10);
    EXPECT_EQ(MSERR_OK, screenCapture_->StopScreenCapture());
    EXPECT_EQ(MSERR_OK, screenCapture_->Release());
}
...
HWTEST_F(ScreenCaptureUnitTest, screen_capture_exclude_content_05, TestSize.Level2)
{
    ...
    RecorderInfo recorderInfo;
    SetRecorderInfo("screen_capture_exclude_content_05.mp4", recorderInfo);
    ...
    EXPECT_EQ(MSERR_OK, screenCapture_->Release());
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_05 after");
}

/**
 * @tc.name: screen_capture_exclude_content_06
 * @tc.desc: screen capture exclude audio content test with save file
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ScreenCaptureUnitTest, screen_capture_exclude_content_06, TestSize.Level2)
{
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_06 before");
    RecorderInfo recorderInfo;
    SetRecorderInfo("screen_capture_exclude_content_06.mp4", recorderInfo);
    SetConfigFile(config_, recorderInfo);
    AudioCaptureInfo micCapInfo = {
        .audioSampleRate = 16000,
        .audioChannels = 2,
...
/**
 * @tc.name: screen_capture_exclude_content_07
 * @tc.desc: screen capture exclude audio content test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ScreenCaptureUnitTest, screen_capture_exclude_content_07, TestSize.Level2)
{
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_07 before");
    RecorderInfo recorderInfo;
    SetRecorderInfo("screen_capture_exclude_content_07.mp4", recorderInfo);
    SetConfigFile(config_, recorderInfo);
    AudioCaptureInfo micCapInfo = {
        .audioSampleRate = 16000,
        .audioChannels = 2,
    ...
    EXPECT_EQ(MSERR_OK, screenCapture_->StopScreenRecording());
    EXPECT_EQ(MSERR_OK, screenCapture_->Release());
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_07 after");
}

/**
 * @tc.name: screen_capture_exclude_content_08
 * @tc.desc: screen capture exclude window and audio content test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ScreenCaptureUnitTest, screen_capture_exclude_content_08, TestSize.Level2)
{
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_08 before");
    RecorderInfo recorderInfo;
    SetRecorderInfo("screen_capture_exclude_content_08.mp4", recorderInfo);
    SetConfigFile(config_, recorderInfo);
    AudioCaptureInfo micCapInfo = {
        .audioSampleRate = 16000,
        .audioChannels = 2,
    ...
    EXPECT_EQ(MSERR_OK, screenCapture_->StopScreenRecording());
    EXPECT_EQ(MSERR_OK, screenCapture_->Release());
    MEDIA_LOGI("ScreenCaptureUnitTest screen_capture_exclude_content_08 after");
}
} // namespace Media
} // namespace OHOS