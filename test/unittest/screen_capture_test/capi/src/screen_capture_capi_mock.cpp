...
int32_t ScreenCaptureCapiMock::ExcludeWindowsContent(int32_t *windowIDs, int32_t windowCount)
{
    UNITTEST_CHECK_AND_RETURN_RET_LOG(screenCapture_ != nullptr, MSERR_INVALID_OPERATION, "screenCapture_ == nullptr");
...
int32_t ScreenCaptureCapiMock::ExcludeAudioContent(int32_t &audioType, int32_t audioCount)
{
    UNITTEST_CHECK_AND_RETURN_RET_LOG(screenCapture_ != nullptr, MSERR_INVALID_OPERATION, "screenCapture_ == nullptr");
    struct OH_AVScreenCapture_ContentFilter *contentFilter = OH_AVScreenCapture_CreateContentFilter();
    OH_AVScreenCapture_ContentFilter_AddAudioContent(contentFilter, static_cast<AVScreenCaptureFilterableAudioContent>(content));
    return OH_AVScreenCapture_ExcludeContent(screenCapture_, contentFilter);
}