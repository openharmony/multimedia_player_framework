...
#ifndef SCREEN_CAPTURE_LISTENER_STUB_UNITTEST_H
#define SCREEN_CAPTURE_LISTENER_STUB_UNITTEST_H
...
namespace OHOS {
namespace Media {
class ScreenCaptureListenerStubTest : public testing::Test {
public:
...
#endif // SCREEN_CAPTURE_LISTENER_STUB_UNITTEST_H