 ...
 */
#ifndef RECORDER_PROFILES_SERVER_MOCK_UNIT_TEST_H
#define RECORDER_PROFILES_SERVER_MOCK_UNIT_TEST_H
...
namespace OHOS {
namespace Media {
class RecorderProfilesServerMockUnitTest : public testing::Test {
public:
    ...
    void TearDown(void);
protected:
    std::shared_ptr<RecorderProfilesServer> recorderProfilesInfoServer_ = nullptr;
