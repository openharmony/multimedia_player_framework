 ...
 */
#ifndef RECORDER_PROFILES_SERVER_UNIT_TEST_H
#define RECORDER_PROFILES_SERVER_UNIT_TEST_H
...
namespace OHOS {
namespace Media {
class RecorderProfilesServerUnitTest : public testing::Test {
public:
    ...
    void TearDown(void);
protected:
    std::shared_ptr<RecorderProfilesServer> recorderProfilesServer_ = nullptr;
