...
/**
* @tc.name  : CacheManagerTest_FlushWriteLength_004
* @tc.number: FlushWriteLength_004
* @tc.desc  : test cacheSize > MAX_CACHE_FILE_SIZE
*/
HWTEST_F(CacheManagerTest, CacheManagerTest_FlushWriteLength_004, TestSize.Level0)
{
    std::string url = "http://example.com/audio.mp3";
    std::string type = "audio";
    bool randomAccess = true;
