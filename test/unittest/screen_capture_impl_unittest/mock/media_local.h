...
public:
    ...
    sptr<IStandardMonitorService> GetMonitorProxy() override { return nullptr; };
    ...
    std::shared_ptr<ILppAudioStreamerService> CreateLppAudioStreamerService() override { return nullptr; };
    std::shared_ptr<ILppVideoStreamerService> CreateLppVideoStreamerService() override { return nullptr; };
    int32_t DestroyLppAudioStreamerService(std::shared_ptr<ILppAudioStreamerService> lppAudioPlayer) override
    { return 0; };
    int32_t DestroyLppVideoStreamerService(std::shared_ptr<ILppVideoStreamerService> lppVideoPlayer) override
    { return 0; };
    LppAvCapabilityInfo *GetLppCapacity() override { return nullptr; };
#endif
