...
uint64_t GetAllPermission()
{
    ...
    std::vector<PermissionStateFull> permissionStates;
    for (const auto& permission : ALL_PERMISSION_LIST) {
        PermissionStateFull permissionState = {
            .permissionName = permission,
            .isGeneral = true,
            .resDeviceID = {"local"},
    ...
    HapPolicyParams hapPolicyParams = {
        .apl = APL_NORMAL,
        .domain = "audio_haptic_test_setup.domain",
        .permList = {},
        .permStateList = permissionStates
    };
    ...
    HapInfoParams hapInfoParams = {
        .userID = 100,
        .bundleName = "audio_haptic_test_setup",
        .instIndex = 0,
        .appIDDesc = "audio_haptic_test_setup",
        .apiVersion = 8,
        .isSystemApp = true
    };
