...
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_001
 * @tc.desc  : Test CheckResolutionRange with input width exceeding max
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_001, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(8000, 4320, 7680, 4320,
        MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
}
 
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_002
 * @tc.desc  : Test CheckResolutionRange with input height exceeding max
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_002, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(7680, 5000, 7680, 4320,
        MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
}
...
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_003
 * @tc.desc  : Test CheckResolutionRange with resolution exactly at max boundary
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_003, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(7680, 4320, 7680, 4320,
        MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
...
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_004
 * @tc.desc  : Test CheckResolutionRange with output width exceeding max
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_004, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(5000, 4096, 4096, 4096,
        MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
 
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_005
 * @tc.desc  : Test CheckResolutionRange with output height exceeding max
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_005, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(4096, 5000, 4096, 4096,
        MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
...
/**
 * @tc.name  : Test CheckResolutionRange
 * @tc.number: CheckResolutionRange_006
 * @tc.desc  : Test CheckResolutionRange with output resolution exactly at max boundary
 */
HWTEST_F(HitranscodeImplUnitTest, CheckResolutionRange_006, TestSize.Level1)
{
    int32_t ret = transcoder_->CheckResolutionRange(4096, 4096, 4096, 4096,
        MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_OK);
}
 
/**
 * @tc.name  : Test CheckCodecCapability
 * @tc.number: CheckCodecCapability_001
 * @tc.desc  : Test CheckCodecCapability with empty mime returns MSERR_OK
 */
HWTEST_F(HitranscodeImplUnitTest, CheckCodecCapability_001, TestSize.Level1)
{
    std::string emptyMime = "";
    int32_t ret = transcoder_->CheckCodecCapability(emptyMime, true, 1920, 1080,
        MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
    EXPECT_EQ(ret, MSERR_OK);
}
 ...
 * @tc.desc  : Test Prepare with input width exceeding MAX_INPUT_VIDEO_WIDTH
 */
HWTEST_F(HitranscodeImplUnitTest, Prepare_004, TestSize.Level1)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 8000;
    transcoder_->inputVideoHeight_ = 4320;
 ...
 * @tc.desc  : Test Prepare with input height exceeding MAX_INPUT_VIDEO_HEIGHT
 */
HWTEST_F(HitranscodeImplUnitTest, Prepare_005, TestSize.Level1)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 5000;
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_WIDTH>(1920);
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_HEIGHT>(1080);
    int32_t ret = transcoder_->Prepare();
    EXPECT_EQ(ret, MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE);
 ...
 * @tc.desc  : Test Prepare with output width exceeding MAX_OUTPUT_VIDEO_WIDTH
 */
HWTEST_F(HitranscodeImplUnitTest, Prepare_006, TestSize.Level1)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 4320;
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_WIDTH>(5000);
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_HEIGHT>(2160);
    int32_t ret = transcoder_->Prepare();
    EXPECT_EQ(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
 ...
 * @tc.desc  : Test Prepare with output height exceeding MAX_OUTPUT_VIDEO_HEIGHT
 */
HWTEST_F(HitranscodeImplUnitTest, Prepare_007, TestSize.Level1)
{
    transcoder_->isExistVideoTrack_ = true;
    transcoder_->inputVideoWidth_ = 7680;
    transcoder_->inputVideoHeight_ = 4320;
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_WIDTH>(3840);
    transcoder_->videoEncFormat_->Set<Tag::VIDEO_HEIGHT>(5000);
    int32_t ret = transcoder_->Prepare();
    EXPECT_EQ(ret, MSERR_TARGET_RESOLUTION_OUT_OF_RANGE);
}
} // namespace Media
