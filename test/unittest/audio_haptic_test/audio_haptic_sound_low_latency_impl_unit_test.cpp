 ...
 * @tc.number: PrepareSound_001
 * @tc.desc  : Test PrepareSound interface
 */
HWTEST_F(AudioHapticSoundLowLatencyImplUnitTest, PrepareSound_001, TestSize.Level1)
{
    AudioSource audioSource = {.audioUri = "123", .fd = FILE_DESCRIPTOR_ZERO};
    bool muteAudio = true;
    ...
    audioHapticSoundLowLatencyImpl->configuredAudioSource_ = {};
    int32_t result = audioHapticSoundLowLatencyImpl->PrepareSound();
    EXPECT_TRUE(audioHapticSoundLowLatencyImpl->configuredAudioSource_.empty());
    EXPECT_EQ(result, MSERR_OPEN_FILE_FAILED);
}

/**
 * @tc.name  : Test AudioHapticSoundLowLatencyImpl API
 * @tc.number: PrepareSound_002
 * @tc.desc  : Test PrepareSound interface
 */
HWTEST_F(AudioHapticSoundLowLatencyImplUnitTest, PrepareSound_002, TestSize.Level1)
{
    ...
    audioHapticSoundLowLatencyImpl->audioSource_ = {};
    audioHapticSoundLowLatencyImpl->configuredAudioSource_ = {};
    int32_t result = audioHapticSoundLowLatencyImpl->PrepareSound();
    EXPECT_TRUE(audioHapticSoundLowLatencyImpl->configuredAudioSource_.empty());
    EXPECT_EQ(result, MSERR_OPEN_FILE_FAILED);
...
/**
 * @tc.name  : Test AudioHapticSoundLowLatencyImpl API
 * @tc.number: PrepareSound_003
 * @tc.desc  : Test PrepareSound interface
 */
HWTEST_F(AudioHapticSoundLowLatencyImplUnitTest, PrepareSound_003, TestSize.Level1)
{
    AudioSource audioSource = {.audioUri = "123", .fd = FILE_DESCRIPTOR_ZERO};
    bool muteAudio = true;
    AudioStandard::StreamUsage streamUsage = AudioStandard::StreamUsage::STREAM_USAGE_UNKNOWN;
    ...
    audioHapticSoundLowLatencyImpl->configuredAudioSource_ = {.audioUri = "456", .fd = FILE_DESCRIPTOR_ZERO};
    audioHapticSoundLowLatencyImpl->audioSource_ = {.audioUri = "123", .fd = FILE_DESCRIPTOR_ZERO};
    ...
    EXPECT_TRUE(!audioHapticSoundLowLatencyImpl->audioSource_.empty());
    int32_t result = audioHapticSoundLowLatencyImpl->PrepareSound();
    EXPECT_EQ(result, MSERR_OPEN_FILE_FAILED);
}
...
/**
 * @tc.name  : Test AudioHapticSoundLowLatencyImpl API
 * @tc.number: PrepareSound_004
 * @tc.desc  : Test PrepareSound interface
 */
HWTEST_F(AudioHapticSoundLowLatencyImplUnitTest, PrepareSound_004, TestSize.Level1)
{
    AudioSource audioSource = {.audioUri = "123", .fd = FILE_DESCRIPTOR_ZERO};
    bool muteAudio = true;
    AudioStandard::StreamUsage streamUsage = AudioStandard::StreamUsage::STREAM_USAGE_UNKNOWN;
...
/**
 * @tc.name  : Test AudioHapticSoundLowLatencyImpl API
 * @tc.number: PrepareSound_005
 * @tc.desc  : Test PrepareSound interface
 */
HWTEST_F(AudioHapticSoundLowLatencyImplUnitTest, PrepareSound_005, TestSize.Level1)
{
    AudioSource audioSource = {};
    bool muteAudio = true;
    AudioStandard::StreamUsage streamUsage = AudioStandard::StreamUsage::STREAM_USAGE_UNKNOWN;
