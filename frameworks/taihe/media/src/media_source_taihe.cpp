...
TH_EXPORT_CPP_API_CreateMediaSourceWithDirectoryWithAsyncCallback(CreateMediaSourceWithDirectorySync);
TH_EXPORT_CPP_API_CreateMediaSourceWithDirectoryRetPromise(CreateMediaSourceWithDirectorySync);