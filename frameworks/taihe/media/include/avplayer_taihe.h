...
struct AVPlayerContext {
    ...
    void ConfigContextEnv(uintptr_t cb);
    ani_env* env_;
    int32_t errCode_ = 0;
    std::string errMessage_ = "";
    ani_resolver bindDeferred_;
    ani_object promise_;
    ani_fn_object callback_;
...
public:
    ...
    void ResetAsync(uintptr_t callback);
    uintptr_t ResetPromise();
    uintptr_t ResetSync(uintptr_t cb);
    void ReleaseAsync(uintptr_t callback);
    uintptr_t ReleasePromise();
    uintptr_t ReleaseSync(uintptr_t cb);
    void PlayAsync(uintptr_t callback);
    uintptr_t PlayPromise();
    uintptr_t PlaySync(uintptr_t cb);
    void PauseAsync(uintptr_t callback);
    uintptr_t PausePromise();
    uintptr_t PauseSync(uintptr_t cb);
    void StopAsync(uintptr_t callback);
    uintptr_t StopPromise();
    uintptr_t StopSync(uintptr_t cb);
    void PrepareAsync(uintptr_t callback);
    uintptr_t PreparePromise();
    uintptr_t PrepareSync(uintptr_t cb);
