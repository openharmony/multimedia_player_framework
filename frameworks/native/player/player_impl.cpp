...
{
    MEDIA_LOGD("PlayerImpl SetSource in(dataSrc)");
...
{
    MEDIA_LOGD("PlayerImpl SetSource in(url): %{public}s", url.c_str());
...
{
    MEDIA_LOGD("PlayerImpl SetSource in(fd)");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl Prepare in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl PrepareAsync in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl Pause in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl Reset in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl Release in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetVolume(%{public}f, %{public}f) in", leftVolume, rightVolume);
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl Seek in, seek to %{public}d ms, mode is %{public}d", mSeconds, mode);
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetCurrentTime in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetVideoTrackInfo in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetAudioTrackInfo in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetVideoWidth in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetVideoHeight in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetPlaybackSpeed in, mode is %{public}d", mode);
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetPlaybackSpeed in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SelectBitRate(%{public}d) in", bitRate);
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl GetDuration in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetVideoSurface in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl IsPlaying in");
...
{
    MEDIA_LOGD("PlayerImpl IsLooping in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, false, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetLooping in, loop %{public}d", loop);
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetPlayerCallback in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
...
{
    MEDIA_LOGD("PlayerImpl SetParameter in");
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, MSERR_INVALID_OPERATION, "player service does not exist..");
