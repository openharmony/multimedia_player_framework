...
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {LOG_CORE, LOG_DOMAIN_SCREENCAPTURE, "ScreenCaptureController"};
}
namespace OHOS {
namespace Media {
...
int32_t ScreenCaptureControllerImpl::GetAVScreenCaptureConfigurableParameters(
    int32_t sessionId, std::string &resultStr)
{
