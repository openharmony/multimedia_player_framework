...
static const PlayerErrorCodeApi9Convert g_errorCodeApi9Map[ERROR_CODE_API9_MAP_LENGTH] = {
    ...
    {MSERR_EXT_API12_IO_CANNOT_FIND_HOST, AV_ERR_IO},
    {MSERR_EXT_API12_IO_CONNECTION_TIMEOUT, AV_ERR_IO},
    {MSERR_EXT_API12_IO_NETWORK_ABNORMAL, AV_ERR_IO},
    {MSERR_EXT_API12_IO_NETWORK_UNAVAILABLE, AV_ERR_IO},
    {MSERR_EXT_API12_IO_NO_PERMISSION, AV_ERR_IO},
    {MSERR_EXT_API12_IO_REQUEST_DENID, AV_ERR_IO},
    {MSERR_EXT_API12_IO_RESOURE_NOT_FOUND, AV_ERR_IO},
    {MSERR_EXT_API12_IO_SSL_CLIENT_CERT_NEEDED, AV_ERR_IO},
    {MSERR_EXT_API12_IO_SSL_CONNECT_FAIL, AV_ERR_IO},
    {MSERR_EXT_API12_IO_SSL_SERVER_CERT_UNTRUSTED, AV_ERR_IO},
    {MSERR_EXT_API12_IO_UNSUPPORTTED_REQEST, AV_ERR_IO},
};
...
void NativeAVPlayerCallback::OnError(int32_t errorCode, const std::string &errorMsg)
{
    ...
    if (errorCallback_) { // errorCallback_ precedes over callback_.onInfo
        ...
        if (errorCode >= MSERR_EXT_API9_NO_PERMISSION && errorCode <= MSERR_EXT_API12_IO_UNSUPPORTTED_REQEST) {
