...
namespace {
    ...
    constexpr uint32_t ERROR_CODE_API9_MAP_LENGTH = 45;
...
static const PlayerErrorCodeApi9Convert g_errorCodeApi9Map[ERROR_CODE_API9_MAP_LENGTH] = {
    ...
    {MSERR_EXT_API14_IO_RESOURE_NOT_FOUND, AV_ERR_IO_RESOURE_NOT_FOUND},
    ...
    {MSERR_EXT_API14_IO_UNSUPPORTTED_REQUEST, AV_ERR_IO_UNSUPPORTTED_REQUEST},
    {MSERR_EXT_API14_IO_DATA_ABNORMAL, AV_ERR_IO_DATA_ABNORMAL},
    {MSERR_EXT_API14_IO_FILE_ACCESS_DENIED, AV_ERR_IO_FILE_ACCESS_DENIED},
    {MSERR_EXT_API14_IO_FILE_BAD_HANDLE, AV_ERR_IO_FILE_BAD_HANDLE},
    {MSERR_EXT_API14_IO_FILE_NOT_FOUND, AV_ERR_IO_FILE_NOT_FOUND},
    {MSERR_EXT_API14_IO_FILE_PERMISSION_DENIED, AV_ERR_IO_FILE_PERMISSION_DENIED},
    {MSERR_EXT_API14_IO_AUDIO_DEC_FAILED, AV_ERR_IO_AUDIO_DEC_FAILED},
    {MSERR_EXT_API14_IO_AUDIO_DEC_INIT_FAILED, AV_ERR_IO_AUDIO_DEC_INIT_FAILED},
    {MSERR_EXT_API14_IO_AUDIO_DEC_UNAVAILABLE, AV_ERR_IO_AUDIO_DEC_UNAVAILABLE},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_ERROR, AV_ERR_IO_AUDIO_DEVICE_ERROR},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_INVALID_STATE, AV_ERR_IO_AUDIO_DEVICE_INVALID_STATE},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_TIMEOUT, AV_ERR_IO_AUDIO_DEVICE_TIMEOUT},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_UNAVAILABLE, AV_ERR_IO_AUDIO_DEVICE_UNAVAILABLE},
    {MSERR_EXT_API14_IO_AUDIO_ENC_FAILED, AV_ERR_IO_AUDIO_ENC_FAILED},
    {MSERR_EXT_API14_IO_AUDIO_ENC_INIT_FAILED, AV_ERR_IO_AUDIO_ENC_INIT_FAILED},
    {MSERR_EXT_API14_IO_AUDIO_ENC_UNAVAILABLE, AV_ERR_IO_AUDIO_ENC_UNAVAILABLE},
    {MSERR_EXT_API14_IO_VIDEO_DEC_FAILED, AV_ERR_IO_VIDEO_DEC_FAILED},
    {MSERR_EXT_API14_IO_VIDEO_DEC_INIT_FAILED, AV_ERR_IO_VIDEO_DEC_INIT_FAILED},
    {MSERR_EXT_API14_IO_VIDEO_DEC_UNAVAILABLE, AV_ERR_IO_VIDEO_DEC_UNAVAILABLE},
    {MSERR_EXT_API14_IO_VIDEO_DEVICE_ERROR, AV_ERR_IO_VIDEO_DEVICE_ERROR},
    {MSERR_EXT_API14_IO_VIDEO_ENC_FAILED, AV_ERR_IO_VIDEO_ENC_FAILED},
    {MSERR_EXT_API14_IO_VIDEO_ENC_INIT_FAILED, AV_ERR_IO_VIDEO_ENC_INIT_FAILED},
    {MSERR_EXT_API14_IO_VIDEO_ENC_UNAVAILABLE, AV_ERR_IO_VIDEO_ENC_UNAVAILABLE},
};
...
void NativeAVPlayerCallback::OnError(int32_t errorCode, const std::string &errorMsg)
{
    ...
    if (errorCallback_) { // errorCallback_ precedes over callback_.onInfo
        ...
        if (errorCode >= MSERR_EXT_API9_NO_PERMISSION && errorCode <= MSERR_EXT_API14_IO_VIDEO_ENC_UNAVAILABLE) {
