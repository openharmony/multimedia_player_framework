...
const std::map<MediaServiceErrCode, MediaServiceExtErrCode> MSERRCODE_TO_EXTERRORCODE = {
    ...
    {MSERR_IO_FILE_ACCESS_DENIED,               MSERR_EXT_IO},
    {MSERR_IO_FILE_BAD_HANDLE,                  MSERR_EXT_IO},
    {MSERR_IO_FILE_NOT_FOUND,                   MSERR_EXT_IO},
    {MSERR_IO_FILE_PERMISSION_DENIED,           MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEC_FAILED,                 MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEC_INIT_FAILED,            MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEC_UNAVAILABLE,            MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEVICE_ERROR,               MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEVICE_INVALID_STATE,       MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEVICE_TIMEOUT,             MSERR_EXT_IO},
    {MSERR_IO_AUDIO_DEVICE_UNAVAILABLE,         MSERR_EXT_IO},
    {MSERR_IO_AUDIO_ENC_FAILED,                 MSERR_EXT_IO},
    {MSERR_IO_AUDIO_ENC_INIT_FAILED,            MSERR_EXT_IO},
    {MSERR_IO_AUDIO_ENC_UNAVAILABLE,            MSERR_EXT_IO},
    {MSERR_IO_VIDEO_DEC_FAILED,                 MSERR_EXT_IO},
    {MSERR_IO_VIDEO_DEC_INIT_FAILED,            MSERR_EXT_IO},
    {MSERR_IO_VIDEO_DEC_UNAVAILABLE,            MSERR_EXT_IO},
    {MSERR_IO_VIDEO_DEVICE_ERROR,               MSERR_EXT_IO},
    {MSERR_IO_VIDEO_ENC_FAILED,                 MSERR_EXT_IO},
    {MSERR_IO_VIDEO_ENC_INIT_FAILED,            MSERR_EXT_IO},
    {MSERR_IO_VIDEO_ENC_UNAVAILABLE,            MSERR_EXT_IO},
};
...
const std::map<MediaServiceErrCode, MediaServiceExtErrCodeAPI9> MSERRCODE_TO_EXTERRORCODEAPI9 = {
    ...
    {MSERR_IO_FILE_ACCESS_DENIED,               MSERR_EXT_API14_IO_FILE_ACCESS_DENIED},
    {MSERR_IO_FILE_BAD_HANDLE,                  MSERR_EXT_API14_IO_FILE_BAD_HANDLE},
    {MSERR_IO_FILE_NOT_FOUND,                   MSERR_EXT_API14_IO_FILE_NOT_FOUND},
    {MSERR_IO_FILE_PERMISSION_DENIED,           MSERR_EXT_API14_IO_FILE_PERMISSION_DENIED},
    {MSERR_IO_AUDIO_DEC_FAILED,                 MSERR_EXT_API14_IO_AUDIO_DEC_FAILED},
    {MSERR_IO_AUDIO_DEC_INIT_FAILED,            MSERR_EXT_API14_IO_AUDIO_DEC_INIT_FAILED},
    {MSERR_IO_AUDIO_DEC_UNAVAILABLE,            MSERR_EXT_API14_IO_AUDIO_DEC_UNAVAILABLE},
    {MSERR_IO_AUDIO_DEVICE_ERROR,               MSERR_EXT_API14_IO_AUDIO_DEVICE_ERROR},
    {MSERR_IO_AUDIO_DEVICE_INVALID_STATE,       MSERR_EXT_API14_IO_AUDIO_DEVICE_INVALID_STATE},
    {MSERR_IO_AUDIO_DEVICE_TIMEOUT,             MSERR_EXT_API14_IO_AUDIO_DEVICE_TIMEOUT},
    {MSERR_IO_AUDIO_DEVICE_UNAVAILABLE,         MSERR_EXT_API14_IO_AUDIO_DEVICE_UNAVAILABLE},
    {MSERR_IO_AUDIO_ENC_FAILED,                 MSERR_EXT_API14_IO_AUDIO_ENC_FAILED},
    {MSERR_IO_AUDIO_ENC_INIT_FAILED,            MSERR_EXT_API14_IO_AUDIO_ENC_INIT_FAILED},
    {MSERR_IO_AUDIO_ENC_UNAVAILABLE,            MSERR_EXT_API14_IO_AUDIO_ENC_UNAVAILABLE},
    {MSERR_IO_VIDEO_DEC_FAILED,                 MSERR_EXT_API14_IO_VIDEO_DEC_FAILED},
    {MSERR_IO_VIDEO_DEC_INIT_FAILED,            MSERR_EXT_API14_IO_VIDEO_DEC_INIT_FAILED},
    {MSERR_IO_VIDEO_DEC_UNAVAILABLE,            MSERR_EXT_API14_IO_VIDEO_DEC_UNAVAILABLE},
    {MSERR_IO_VIDEO_DEVICE_ERROR,               MSERR_EXT_API14_IO_VIDEO_DEVICE_ERROR},
    {MSERR_IO_VIDEO_ENC_FAILED,                 MSERR_EXT_API14_IO_VIDEO_ENC_FAILED},
    {MSERR_IO_VIDEO_ENC_INIT_FAILED,            MSERR_EXT_API14_IO_VIDEO_ENC_INIT_FAILED},
    {MSERR_IO_VIDEO_ENC_UNAVAILABLE,            MSERR_EXT_API14_IO_VIDEO_ENC_UNAVAILABLE},
};
...
const std::map<MediaServiceExtErrCodeAPI9, std::string> MSEXTERRCODE_API9_INFOS = {
    ...
    {MSERR_EXT_API14_IO_FILE_ACCESS_DENIED, "IO file access denied: "},
    {MSERR_EXT_API14_IO_FILE_BAD_HANDLE, "IO file bad handle: "},
    {MSERR_EXT_API14_IO_FILE_NOT_FOUND, "IO file not found: "},
    {MSERR_EXT_API14_IO_FILE_PERMISSION_DENIED, "IO file permission denied: "},
    {MSERR_EXT_API14_IO_AUDIO_DEC_FAILED, "IO decode failed: "},
    {MSERR_EXT_API14_IO_AUDIO_DEC_INIT_FAILED, "audio decode init failed: "},
    {MSERR_EXT_API14_IO_AUDIO_DEC_UNAVAILABLE, "audio decode unavailable: "},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_ERROR, "audio device error: "},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_INVALID_STATE, "audio device invalid state: "},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_TIMEOUT, "audio device timeout: "},
    {MSERR_EXT_API14_IO_AUDIO_DEVICE_UNAVAILABLE, "audio device unavailable: "},
    {MSERR_EXT_API14_IO_AUDIO_ENC_FAILED, "audio encode failed: "},
    {MSERR_EXT_API14_IO_AUDIO_ENC_INIT_FAILED, "audio encode init failed: "},
    {MSERR_EXT_API14_IO_AUDIO_ENC_UNAVAILABLE, "audio encode unavailable: "},
    {MSERR_EXT_API14_IO_VIDEO_DEC_FAILED, "video decode failed: "},
    {MSERR_EXT_API14_IO_VIDEO_DEC_INIT_FAILED, "video decode init failed: "},
    {MSERR_EXT_API14_IO_VIDEO_DEC_UNAVAILABLE, "video decode unavailable: "},
    {MSERR_EXT_API14_IO_VIDEO_DEVICE_ERROR, "video device error: "},
    {MSERR_EXT_API14_IO_VIDEO_ENC_FAILED, "video encode failed: "},
    {MSERR_EXT_API14_IO_VIDEO_ENC_INIT_FAILED, "video encode init failed: "},
