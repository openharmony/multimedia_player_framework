...
const std::map<MediaServiceErrCode, std::string> MSERRCODE_INFOS = {
    ...
    {MSERR_VID_ENC_CONFIG_FAILED, "Video encode config failed"},
    ...
    {MSERR_AUD_FAILED, "AudioCapturer failed"},
    {MSERR_AUD_INIT_FAILED, "AudioCapturer create failed"},
    {MSERR_AUD_START_FAILED, "AudioCapturer start failed"},
    {MSERR_AUD_STOP_FAILED, "AudioCapturer stop failed"},
...
const std::map<MediaServiceErrCode, MediaServiceExtErrCodeAPI9> MSERRCODE_TO_EXTERRORCODEAPI9 = {
    ...
    {MSERR_PARAM_OUT_OF_RANGE,                  MSERR_EXT_API20_PARAM_ERROR_OUT_OF_RANGE},
    {MSERR_VID_DEC_INIT_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_AUD_DEC_INIT_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_VID_DEC_CONFIGURE_FAILED,            MSERR_EXT_API9_IO},
    {MSERR_AUD_DEC_CONFIGURE_FAILED,            MSERR_EXT_API9_IO},
    {MSERR_VID_ENHANCER_CONFIGURE_FAILED,       MSERR_EXT_API9_IO},
    {MSERR_NO_VALID_TRACK_FOUND,                MSERR_EXT_API9_UNSUPPORT_FORMAT},
    {MSERR_SET_INPUT_DATA_SOURCE_FAILED,        MSERR_EXT_API9_UNSUPPORT_FORMAT},
    {MSERR_VID_ENC_CONFIG_FAILED,               MSERR_EXT_API9_IO},
    {MSERR_VID_ENC_INIT_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_VID_ENC_START_FAILED,                MSERR_EXT_API9_IO},
    {MSERR_VID_ENC_STOP_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_AUD_ENC_INIT_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_AUD_ENC_START_FAILED,                MSERR_EXT_API9_IO},
    {MSERR_AUD_ENC_STOP_FAILED,                 MSERR_EXT_API9_IO},
    {MSERR_AUD_FAILED,                          MSERR_EXT_API9_IO},
    {MSERR_AUD_INIT_FAILED,                     MSERR_EXT_API9_IO},
    {MSERR_AUD_START_FAILED,                    MSERR_EXT_API9_IO},
    {MSERR_AUD_STOP_FAILED,                     MSERR_EXT_API9_IO},
    {MSERR_MUXER_INIT_FAILED,                   MSERR_EXT_API9_IO},
    {MSERR_MUXER_START_FAILED,                  MSERR_EXT_API9_IO},
    {MSERR_MUXER_STOP_FAILED,                   MSERR_EXT_API9_IO},
    {MSERR_VID_CAPTURE_CONFIG_FAILED,           MSERR_EXT_API9_IO},
    {MSERR_FRAMEWORK_ERROR,                     MSERR_EXT_API9_IO},
    {MSERR_INVALID_TIMESTAMP,                   MSERR_EXT_API9_IO},
    {MSERR_INVALID_OUTPUT_RESOLUTION,           MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_AUDIO_BITRATE,               MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_WATERMARK_NUM_OUT_OF_RANGE,          MSERR_EXT_API20_PARAM_ERROR_OUT_OF_RANGE},
    {MSERR_FRAMEWORK_INTERNAL_ERROR,            MSERR_EXT_API9_NO_MEMORY},
    {MSERR_VIDEO_RESOLUTION_OUT_OF_RANGE,       MSERR_EXT_API9_IO},
    {MSERR_TARGET_RESOLUTION_OUT_OF_RANGE,      MSERR_EXT_API9_IO},
    {MSERR_INVALID_FD,                          MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_WRITE,                       MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_AUD_BITRATE,                 MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_INNERCAP,                    MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_VID_CODEC_FORMAT,            MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_VID_BITRATE,                 MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_VID_FRAME_WIDTH,             MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_VID_FRAME_HEIGHT,            MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_VID_WIDTH_HEIGHT,            MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_AUD_CHANNEL,                 MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_AUD_SAMPLE_RATE,             MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_FILL_MODE,                   MSERR_EXT_API9_INVALID_PARAMETER},
    {MSERR_INVALID_OPERATION_CREATE,            MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_INVALID_OPERATION_OVERSIZE,          MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_UNKNOWN_RECORDER_INIT,               MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_SETFILE,            MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_PREPARE,            MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_GETSURFACE,         MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_SETAUDIO,           MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_PAUSE,              MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_STOP,               MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_RESUME,             MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_RECORDER_WATERMASK,          MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_CREAT_RECORDER,              MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_CREATE_VIRTUAL_SCREEN,       MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_MAKE_MIRROR,                 MSERR_EXT_API9_IO},
    {MSERR_UNKNOWN_INCALL,                      MSERR_EXT_API9_IO},
    {MSERR_UNSUPPORT_INCALL,                    MSERR_EXT_API9_UNSUPPORT_FORMAT},
    {MSERR_UNKNOWN_AUDIO_CREATE,                MSERR_EXT_API9_IO},
    {MSERR_INVALID_OPERATION_STOPPED_PAUSED,    MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_UNKNOWN_AUDIO_START,                 MSERR_EXT_API9_IO},
    {MSERR_INVALID_OPERATION_ENABLEPAUSE,       MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_INVALID_OPERATION_STARTED_RESUMED,   MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_INVALID_OPERATION_PAUSED,            MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_INVALID_OPERATION_AREA,              MSERR_EXT_API9_OPERATE_NOT_PERMIT},
    {MSERR_INVALID_OPERATION_UNSUPPORT,         MSERR_EXT_API9_OPERATE_NOT_PERMIT},
...
std::string MSExtErrorToString(MediaServiceExtErrCode code)
{
    ...
    if (code > MSERR_EXT_EXTEND_START) {
        return "extend error code:" + std::to_string(static_cast<int32_t>(code - MSERR_EXT_EXTEND_START));
    }
