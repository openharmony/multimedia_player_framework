...
const std::map<MediaServiceErrCode, MediaServiceExtErrCode> MSERRCODE_TO_EXTERRORCODE = {
    ...
    {MSERR_IO_REQUEST_DENID,                    MSERR_EXT_IO},
    ...
    {MSERR_IO_UNSUPPORTTED_REQEST,              MSERR_EXT_IO},
};
...
const std::map<MediaServiceErrCode, MediaServiceExtErrCodeAPI9> MSERRCODE_TO_EXTERRORCODEAPI9 = {
    ...
    {MSERR_IO_REQUEST_DENID,                    MSERR_EXT_API14_IO_REQUEST_DENID},
    ...
    {MSERR_IO_UNSUPPORTTED_REQEST,              MSERR_EXT_API14_IO_UNSUPPORTTED_REQEST}
};
...
const std::map<MediaServiceExtErrCodeAPI9, std::string> MSEXTERRCODE_API9_INFOS = {
    ...
    {MSERR_EXT_API14_IO_REQUEST_DENID, "IO Request Denied: "},
    ...
    {MSERR_EXT_API14_IO_UNSUPPORTTED_REQEST, "IO Unsupported Request: "},
};
