...
public:
    static std::shared_ptr<IGraphicsRenderEngine> CreateGraphicsRender();
    ...
    virtual VEFError Init(OHNativeWindow* window) = 0;
    ...
    virtual OHNativeWindow* GetRenderNativeWindow() = 0;
