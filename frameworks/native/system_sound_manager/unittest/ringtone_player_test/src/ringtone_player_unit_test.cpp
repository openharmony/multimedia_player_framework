 ...
 * @tc.number: MockMode_RingtonePlayer_001
 * @tc.desc  : Test Mock mode constructor
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_001, TestSize.Level0)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    RingtoneType type = RINGTONE_TYPE_SIM_CARD_0;
...
/**
 * @tc.name  : Test MediaRingtonePlayer MockMode
 * @tc.number: MockMode_RingtonePlayer_002
 * @tc.desc  : Test Mock mode constructor with empty settings
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_002, TestSize.Level1)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    RingtoneType type = RINGTONE_TYPE_SIM_CARD_0;
...
/**
 * @tc.name  : Test MediaRingtonePlayer MockMode
 * @tc.number: MockMode_RingtonePlayer_Start_001
 * @tc.desc  : Test Mock mode Start with DEFAULT mode
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_Start_001, TestSize.Level1)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    RingtoneType type = RINGTONE_TYPE_SIM_CARD_0;
...
/**
 * @tc.name  : Test MediaRingtonePlayer MockMode
 * @tc.number: MockMode_RingtonePlayer_Start_002
 * @tc.desc  : Test Mock mode Start with FAST mode and NeedToVibrate=true
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_Start_002, TestSize.Level1)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    sysSoundMgr->ringerMode_ = AudioStandard::AudioRingerMode::RINGER_MODE_NORMAL;
...
/**
 * @tc.name  : Test MediaRingtonePlayer MockMode
 * @tc.number: MockMode_RingtonePlayer_RegisterSource_001
 * @tc.desc  : Test RegisterSource in Mock mode
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_RegisterSource_001, TestSize.Level0)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    RingtoneType type = RINGTONE_TYPE_SIM_CARD_0;
...
/**
 * @tc.name  : Test MediaRingtonePlayer MockMode
 * @tc.number: MockMode_RingtonePlayer_RegisterSource_002
 * @tc.desc  : Test RegisterSource in normal mode (not Mock)
 */
HWTEST(RingtonePlayerUnitTest, MockMode_RingtonePlayer_RegisterSource_002, TestSize.Level0)
{
    auto context_ = std::make_shared<ContextImpl>();
    auto sysSoundMgr = std::make_shared<SystemSoundManagerImpl>();
    RingtoneType type = RINGTONE_TYPE_SIM_CARD_0;
    ...
    ringtonePlayerImpl_->isMockMode_ = false;
    std::string audioUri = "/path/to/audio.ogg";
    std::string hapticUri = "/path/to/haptic.json";
    int32_t sourceId = ringtonePlayerImpl_->RegisterSource(audioUri, hapticUri);
    EXPECT_NE(sourceId, -1);
