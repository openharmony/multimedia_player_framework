...
#ifndef MOCK_DATASHARE_RESULT_SET_H
#define MOCK_DATASHARE_RESULT_SET_H
...
public:
    ...
    using DataShare::DataShareResultSet::Finalize;
    ...
    MOCK_METHOD(int, GetDataType, (int columnIndex, DataShare::DataType& dataType), (override));
    ...
    MOCK_METHOD(bool, OnGo, (int oldRowIndex, int newRowIndex, int *cachedIndex), (override));
...
#endif // MOCK_DATASHARE_RESULT_SET_H
