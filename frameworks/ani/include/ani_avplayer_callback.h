 ...
 */
#ifndef ANI_AV_PLAYER_CALLBACK_H
#define ANI_AV_PLAYER_CALLBACK_H
...
namespace OHOS {
namespace Media {
class ANIAVPlayerNotify {
public:
    ANIAVPlayerNotify() = default;
    virtual ~ANIAVPlayerNotify() = default;
...
private:
    ...
    ANIAVPlayerNotify *listener_ = nullptr;
...
#endif // ANI_AV_PLAYER_CALLBACK_H