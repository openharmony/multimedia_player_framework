...
const std::unordered_map<MediaServiceErrCode, std::string> MSSCERRCODE_FUNCS = {
    {MSERR_OK,                                  "success"},
    {MSERR_NO_MEMORY,                           "Framework internal error."},
    {MSERR_INVALID_OPERATION,                   "Framework internal error."},
    {MSERR_INVALID_VAL,                         "invalid argument."},
    {MSERR_UNKNOWN,                             "Framework internal error."},
    {MSERR_SERVICE_DIED,                        "Media service died."},
    {MSERR_INVALID_STATE,                       "Framework internal error."},
    {MSERR_UNSUPPORT,                           "Framework internal error."},
    {MSERR_DATA_SOURCE_ERROR_UNKNOWN,           "error due to virtual screen. "},
    {MSERR_VID_ENC_FAILED,                      "error due to recorder."},
    {MSERR_AUD_ENC_FAILED,                      "create audioCapture failed."},
    {MSERR_UNSUPPORT_AUD_CHANNEL_NUM,           "Unsupported audioChannelCount parameter."},
    {MSERR_UNSUPPORT_AUD_SAMPLE_RATE,           "Unsupported audioSampleRate parameter."},
