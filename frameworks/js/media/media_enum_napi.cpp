...
static const std::vector<struct JsEnumInt> g_screenCaptureStateCode = {
    ...
    { "SCREENCAPTURE_STATE_PAUSED_BY_USER", AVScreenCaptureStateCode::SCREEN_CAPTURE_STATE_PAUSED_BY_USER },
    { "SCREENCAPTURE_STATE_RESUMED_BY_USER", AVScreenCaptureStateCode::SCREEN_CAPTURE_STATE_RESUMED_BY_USER },
    { "SCREENCAPTURE_STATE_PAUSED_BY_APP", AVScreenCaptureStateCode::SCREEN_CAPTURE_STATE_PAUSED_BY_APP },
    { "SCREENCAPTURE_STATE_RESUMED_BY_APP", AVScreenCaptureStateCode::SCREEN_CAPTURE_STATE_RESUMED_BY_APP },
};
...
static const std::vector<struct JsEnumInt> g_avMetricsEventType = {
    ...
    { "AV_METRICS_EVENT_LIP_ASYNC", AVMetricsEventType::AV_METRICS_EVENT_TYPE_LIP_ASYNC },
    { "AV_METRICS_EVENT_LOADINGRATE_CHANGE", AVMetricsEventType::AV_METRICS_EVENT_TYPE_LOADINGRATE_CHANGE },
    { "AV_METRICS_EVENT_LOADING_ERROR", AVMetricsEventType::AV_METRICS_EVENT_TYPE_LOADING_ERROR },
    { "AV_METRICS_EVENT_CONTENT_CHANGED", AVMetricsEventType::AV_METRICS_EVENT_TYPE_CONTENT_CHANGED },
    { "AV_METRICS_EVENT_CONTENT_DISCONTINUITY", AVMetricsEventType::AV_METRICS_EVENT_TYPE_CONTENT_DISCONTINUITY },
    { "AV_METRICS_EVENT_CODEC_ABNORMAL", AVMetricsEventType::AV_METRICS_EVENT_TYPE_CODEC_ABNORMAL },
    { "AV_METRICS_EVENT_AUDIO_ABNORMAL", AVMetricsEventType::AV_METRICS_EVENT_TYPE_AUDIO_ABNORMAL },
};
