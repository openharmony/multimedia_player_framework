...
napi_value AudioEncoderNapi::On(napi_env env, napi_callback_info info)
{
    ...
    audioEncoderNapi->SetCallbackReference(callbackName, autoRef);
    return result;
}
...
void AudioEncoderNapi::SetCallbackReference(const std::string &callbackName, std::shared_ptr<AutoRef> ref)
{
