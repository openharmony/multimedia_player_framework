...
const std::string NAPI_ERR_DATA_TOO_LARGE_INFO = "File size over limit. For video, the upper limit is 200M";
const std::string NAPI_ERR_TOO_MANY_FILES_INFO = "File count over limit. For video, the upper limit is 40";
