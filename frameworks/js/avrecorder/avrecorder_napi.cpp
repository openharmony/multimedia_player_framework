    ...
    napi_value item, AVRecorderProfile profile)
{
    ...
    CHECK_AND_RETURN_RET(CommonNapi::GetPropertyBool(env, item, "enableTemporalScale", profile.enableTemporalScale),
        (asyncCtx->AVRecorderSignError(ret, "GetenableTemporalScale", "enableTemporalScale"), ret));
