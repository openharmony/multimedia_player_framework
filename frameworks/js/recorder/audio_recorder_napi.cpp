...
bool AudioRecorderNapi::GetAudioEncAndFileFormat(napi_env env, napi_value args, AudioRecorderProperties &properties)
{
    bool ret = false;
...
int32_t AudioRecorderNapi::OnPrepare(const std::string &uriPath, const AudioRecorderProperties &properties)
{
    ...
    CHECK_AND_RETURN_RET_LOG(properties.numberOfChannels > 0, MSERR_INVALID_VAL, "encodeBitRate invalid value");
