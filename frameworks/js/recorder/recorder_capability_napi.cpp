...
namespace {
    constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {LOG_CORE, LOG_DOMAIN_RECORDER, "RecorderCapabilityNapi"};
}
...
napi_value RecorderCapabilityNapi::GetVideoRecorderProfile(napi_env env, napi_callback_info info)
{
    ...
    asyncCtx->deferred = CommonNapi::CreatePromise(env, asyncCtx->callbackRef, ret);
